...
type PublicJob = { id: string; title: string; category: string; description: string; amount: number; status: string; createdAt: string; customer?: { displayName: string }; attachmentUrl?: string | null; attachmentName?: string | null };
